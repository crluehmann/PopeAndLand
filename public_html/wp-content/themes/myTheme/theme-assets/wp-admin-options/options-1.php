		...
		switch ( $value['type'] ) :
			...
			break;
				...
				<li>
                    ...
                    <p><textarea name="<?php echo $value['id']; ?>" cols="105" rows="10"><?php echo htmlspecialchars(get_option( $value['id'], $value['default_value']  )); ?></textarea></p>
...
function ds_put_theme_options_in_sidebar1() {
	...
	add_submenu_page( 'functions.php', 'Homepage options', 'Homepage options', 8, basename(__FILE__), 'ds_write_theme_options1' );
