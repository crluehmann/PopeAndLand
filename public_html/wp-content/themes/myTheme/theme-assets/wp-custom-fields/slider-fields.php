<?php
global $post;
$ds_prepare_slider_fields = array (
	/*
	array(
		'name' => 'slider name',
		'desc' => 'Name of slider',
		'id' => $ds_custom_field_key . 'slider_name',
	...
	*/
	array(
		'name' => 'website url',
		'desc' => 'website url',
		'id' => $ds_custom_field_key . 'resource_url',
		'type' => 'ec_full_colum',
		'default_value' => ''
	),
...
/*
	array(
		'name' => 'Column right text',
		'desc' => 'Please insert your text',
		'id' => $ds_custom_field_key . 'column_right',
		'type' => 'ec_full_area_colum_editor',
		'default_value' => ''
	)
	
	array(
		'name' => 'Venue Home page',
		'desc' => 'Venue Home page url',
		'id' => $ds_custom_field_key . 'venue_home',
		'type' => 'ec_single_colum_end',
		'default_value' => ''
	),
	array(
		'name' => 'Venue date',
		'desc' => 'Date of venue',
		'id' => $ds_custom_field_key . 'venue_date',
		'type' => 'ec_single_colum_start_date',
		'default_value' => ''
	),
	array(
		'name' => 'Venue city',
		'desc' => 'City of venue',
		'id' => $ds_custom_field_key . 'venue_city',
		'type' => 'ec_single_colum',
		'default_value' => ''
	),
	array(
		'name' => 'Venue state',
		'desc' => 'Venue state',
		'id' => $ds_custom_field_key . 'venue_state',
		'type' => 'ec_single_colum_end',
		'default_value' => ''
	),
	array(
		'name' => 'Venue country',
		'desc' => 'Venue country',
		'id' => $ds_custom_field_key . 'venue_country',
		'type' => 'ec_single_colum_start',
		'default_value' => ''
	),
	array(
		'name' => 'Venue zip code',
		'desc' => 'Venue zip code',
		'id' => $ds_custom_field_key . 'venue_zipcode',
		'type' => 'ec_single_colum',
		'default_value' => ''
	),
	array(
		'name' => 'Venue street ',
		'desc' => 'Venue street',
		'id' => $ds_custom_field_key . 'venue_street',
		'type' => 'ec_single_colum_end',
		'default_value' => ''
	),
	array(
		'name' => 'Generate address for google map',
		'desc' => 'Generate address for google map',
		'id' => $ds_custom_field_key . 'venue_google_map_address',
		'type' => 'ec_full_map',
		'default_value' => ''
	)
	*/
...
function ds_write_slider_fields() {
	global $post, $ds_prepare_slider_fields;
	echo'
		...
		<table cellspacing="0" id="inactive-plugins-table" style="width: 100%;">
			...
			foreach ( $ds_prepare_slider_fields as $custom_field ) :
				...
				switch ( $custom_field['type'] ) :
                  ...
                  <tr>
                     ...
                     <td  >
						...
						<?php
					break;
					case 'ec_full_area_colum_editor':
						?>
	               ...
	               <?php $temp = get_post_meta($post->ID, $custom_field['id'] . '_value', true); ?>
                     ...
                     <td  colspan="4">
						...
						jQuery("#<?php echo $custom_field['id'] . '_value'; ?>").addClass("mceEditor");
						if ( typeof( tinyMCE ) == "object" && typeof( tinyMCE.execCommand ) == "function" ) {
						tinyMCE.execCommand("mceAddControl", false, "<?php echo $custom_field['id'] . '_value'; ?>");
						}
                        ...
                        <p><strong><?php echo $custom_field['name']; ?></strong></p>
                        <p><?php echo $custom_field['desc']; ?></p>
                        <div style="background:#ffffff;"> <textarea id="<?php echo $custom_field['id'] . '_value'; ?>" style="width:100%;" tabindex="6" name="<?php echo $custom_field['id'] . '_value'; ?>" cols="40" rows="10"><?php if ( $temp != "") { echo $temp; } else { echo $custom_field['default_value']; } ?></textarea></div>
                        <input name="<?php echo $custom_field['id'] . '_noncename'; ?>" id="<?php echo $custom_field['id'] . '_noncename'; ?>" type="hidden" value="<?php echo wp_create_nonce( plugin_basename(__FILE__) ) ?>"/>
                  ...
                  <tr>
	               ...
	               <?php $temp = get_post_meta($post->ID, $custom_field['id'] . '_value', true); ?>
                     ...
                     <td  colspan="2">
                        ...
                        <p><strong><?php echo $custom_field['name']; ?></strong></p>
                        <p><?php echo 'Using the <a href="media-upload.php?post_id='.$post->ID.'&type=image&TB_iframe=1&width=640&height=522" target="" class="thickbox">media library</a>, upload an image and paste the file URL here. This is the post excerpt image and it will automatically be resized.'; ?></p>
                        <p> <input style="width: 100%" id="<?php echo $custom_field['id'] . '_value'; ?>" name="<?php echo $custom_field['id'] . '_value'; ?>" type="text" value="<?php if ( $temp != "") { echo $temp; } else { echo $custom_field['default_value']; } ?>" /></p>
                        <input name="<?php echo $custom_field['id'] . '_noncename'; ?>" id="<?php echo $custom_field['id'] . '_noncename'; ?>" type="hidden" value="<?php echo wp_create_nonce( plugin_basename(__FILE__) ) ?>"/>
...
function ds_init_slider_fields() {
	
	if ( function_exists('add_meta_box') ) :
			add_meta_box( 'new-meta-boxes', 'Theme Custom Fields', 'ds_write_slider_fields', 'slider', 'normal', 'high' );
		//add_meta_box( 'new-meta-boxes', 'Theme Custom Fields', 'ds_write_slider_fields', 'slider', 'normal', 'high' );
...
function ds_save_slider_fields( $post_id ) {
	
		global $post, $ds_prepare_slider_fields, $ds_custom_field_key;
...
add_action('admin_menu', 'ds_init_slider_fields');
add_action('save_post', 'ds_save_slider_fields');
